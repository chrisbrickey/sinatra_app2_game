require "./lib/mygame/map.rb"  #is this the right path?
require "test/unit"

class TestGame < Test::Unit::TestCase

  def test_room()
    gold = Map::Room.new("GoldRoom::Room", "This room has gold. There's a door to the north.")
    assert_equal("GoldRoom::Room", gold.name)
